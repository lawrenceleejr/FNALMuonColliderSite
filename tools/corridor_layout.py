...
Pure stdlib. Outputs: geo/layout.geojson, geo/summary.json,
map/layout_data.js, figs/corridor_profile.svg, and a printed report.
"""
...
# Dose-model knobs (see docs/SAFETY.md for provenance)
...
with open(os.path.join(ROOT, 'geo', 'layout.geojson'), 'w') as f:
    json.dump(geojson, f, indent=1)
os.makedirs(os.path.join(ROOT, 'map'), exist_ok=True)
with open(os.path.join(ROOT, 'map', 'layout_data.js'), 'w') as f:
...
profile_svg(os.path.join(ROOT, 'figs', 'corridor_profile.svg'))
...
with open(os.path.join(ROOT, 'geo', 'summary.json'), 'w') as f:
...
print()
print("Wrote geo/layout.geojson, geo/summary.json, map/layout_data.js, figs/corridor_profile.svg")

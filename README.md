...
| [`static/tool/index.html`](static/tool/index.html) | Interactive beam-geometry tool: terrain + stratigraphy ray trace, constraint solver, emergence map, interaction-length accounting |

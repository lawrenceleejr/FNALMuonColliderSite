...
laboratory fence}, delivering ${\sim}10^{12}$ TeV-scale neutrino
interactions per year to a one-tonne on-site experiment before climbing a
...
${\sim}3\times10^{8}$ interactions per tonne-year. The second interaction point's
...
beyond the laboratory fence is bounded at a factor ${\gtrsim}45$ ---
typically orders of magnitude --- below drinking-water limits. The
...
${\sim}7\times10^{12}$ charged- and neutral-current interactions per
tonne-year on axis (CSMS cross-sections, both species per decay) at
$\langle E_\nu\rangle\simeq3.2$~TeV --- eight orders of
...
${\sim}3\times10^{8}$ interactions per tonne-year: the exit strip that must be
...
${\sim}28$~km out and ceiling at $45\times$ and $190\times$ below the
limit; the chord bottoms in the brackish Mt.~Simon; and the drift sands
near Champaign--Urbana ceiling at ${\sim}10^{4}\times$ below.
